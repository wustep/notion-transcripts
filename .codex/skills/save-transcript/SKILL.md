...
- [Codex] Exclude any meta/system context blocks (e.g. `<INSTRUCTIONS>`, `AGENTS.md` dumps, `<environment_context>`, or other harness/system instructions).
- [Codex] Do not mention these exclusions anywhere (not in the page title, summary, transcript body, or confirmation text).
